...
import com.google.android.samples.dynamicfeatures.test.ResourcesHookHelper.logAssetInfo
...
abstract class BaseSplitActivity : AppCompatActivity() {
    ...
    override fun attachBaseContext(newBase: Context?) {
        logAssetInfo("BaseSplitActivity before createConfigurationContext", newBase)

        val ctx = newBase?.let { LanguageHelper.getLanguageConfigurationContext(it) }
        super.attachBaseContext(ctx)

        logAssetInfo("BaseSplitActivity after createConfigurationContext", this)
